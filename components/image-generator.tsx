    ...
    <div className="fixed inset-0 bg-black/70 dark:bg-black/90 backdrop-blur-md flex items-end md:items-center justify-center p-0 md:p-4 z-50">
      ...
      {showShareMenu && (
        <>
          ...
          <div className="absolute bottom-0 left-0 right-0 z-50 bg-white/95 dark:bg-black/95 backdrop-blur-xl border-t border-amber-200/50 dark:border-amber-500/20 rounded-t-3xl p-6 safe-area-inset-bottom">
            <div className="flex justify-center mb-6">
              <div className="w-12 h-1.5 bg-amber-300/50 dark:bg-amber-600/50 rounded-full" />
            </div>
            <h3 className="text-xl font-serif font-semibold text-amber-900 dark:text-amber-300 text-center mb-6">Share to App</h3>
